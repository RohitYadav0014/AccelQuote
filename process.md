...
- **Error**: "Mixed Content: The page at 'https://...' was loaded over HTTPS, but requested an insecure resource 'http://accelquote-api.blacksmoke-120b4be7.westus2.azurecontainerapps.ioget_file_list'"
- **Solution**: 
